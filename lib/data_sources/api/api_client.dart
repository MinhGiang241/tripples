...
class ApiClient {
  ...
  static Future signInGoogle(file) async {
    ...
    const clientIosId =
        '658119356428-f8fvqrnc2ds3h29h1caq1aufdg4gbeo4.apps.googleusercontent.com';

    try {
      var googleSignIn = GoogleSignIn(
        serverClientId: Platform.isIOS ? clientIosId : clientId,
        // clientId: Platform.isIOS ? clientIosId : null,
        // clientId: clientIosId,
        scopes: [
          'email',
