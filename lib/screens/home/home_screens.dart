...
class HomeScreen extends StatefulWidget {
  HomeScreen({this.year, this.month});
  final int? year;
  final int? month;
  @override
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    year = widget.year != null ? widget.year as int : DateTime.now().year;
    month = widget.month != null ? widget.month as int : DateTime.now().month;
