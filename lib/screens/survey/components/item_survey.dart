...
import '../controllers/multichoise_controller.dart';
  ...
  void initState() {
    ...
    scoreController = TextEditingController(
        text: widget.questionResult != null
            ...
            : '0'); // widget.question.maxScore.toString());
...
class ScoreSlider extends StatelessWidget {
  ...
  final Function(String)? textScore;
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SliderScoreController>(
        ...
        builder: (context, child) {
          ...
          if (!isReadOnly && double.tryParse(scoreController!.text) != null) {
            Provider.of<SliderScoreController>(context, listen: false)
                .changeValue(double.parse(scoreController!.text), index,
                    context, questID, autoScore);
          }
                        ...
                        Expanded(
                          ...
                          validator: (v) {
                            if (!isReadOnly &&
                              ...
                              if (double.parse(v) > maxScore) {
                                return 'Không được lớn hơn điểm tối đa';
                              }
                            }
                            return null;
                          },
                          onChanged: (v) {
                            if ((!isReadOnly && double.tryParse(v) != null)) {
